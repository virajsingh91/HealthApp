...
<br>
<form method="post" action="CrudInsertMedicine">
   <%if(text != null ){
    out.print(text);   
   }
   else {
   }%><br>
     <input type="text" class="focus"id="login"name="orgname" placeholder="Org Name" required><br>
     <input type="text" id="password"  name="noofemp" placeholder="No of Employees" required><br>
     ...
     <input type="text" id="password"  name="phone" placeholder="Phone#" required><br>
      <input type="email" id="password"  name="email" placeholder="Email" required><br>
