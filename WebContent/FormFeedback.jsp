...
<br>
<form method="post" action="CrudInsertFeedback">
   <%if(text != null ){
    out.print(text);   
   }
   else {
   }%><br>
     <input type="text" class="focus"id="login"name="vehno" placeholder="Vehicle Number" required><br>
     <input type="text" id="password"  name="avail" placeholder="Available ? TRUE/FALSE" required><br>
