...
<br>
<form method="post" action="CrudInsert">
   <%if(text != null ){
    out.print(text);   
   }
   else {
   }%><br>
     <input type="text" class="focus"id="login"name="PharmacyName" placeholder="Pharmacy Name" required><br>
     ...
     <input type="text" id="password"  name="Zip" placeholder="Zip Code" required><br>
     <input type="tel" id="password"  name="Phone" placeholder="Phone" required><br>
